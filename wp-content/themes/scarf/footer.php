		...
		<div class="scarf-footer__main">
			...
			<div class="scarf-footer__column">
				...
				<div class="scarf-footer__social">
					<a href="#" aria-label="<?php esc_attr_e( 'اینستاگرام', 'scarf' ); ?>">
					...
					<a href="#" aria-label="<?php esc_attr_e( 'تلگرام', 'scarf' ); ?>">
					...
					<a href="#" aria-label="<?php esc_attr_e( 'واتساپ', 'scarf' ); ?>">
			...
			<div class="scarf-footer__column">
				...
				<p><?php esc_html_e( 'تلفن: ۰۲۱-۱۲۳۴۵۶۷۸', 'scarf' ); ?></p>
				<p><?php esc_html_e( 'ایمیل: info@scarfstore.ir', 'scarf' ); ?></p>
				<p><?php esc_html_e( 'ساعات پاسخگویی: ۹ صبح تا ۱۸', 'scarf' ); ?></p>
			</div>
		</div>
