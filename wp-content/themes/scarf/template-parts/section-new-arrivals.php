...
<section class="scarf-section scarf-container scarf-section--new-arrivals">
	<?php
	$shop_url = function_exists( 'wc_get_page_permalink' ) ? wc_get_page_permalink( 'shop' ) : home_url( '/' );
	echo scarf_section_heading( __( 'محصولات جدید', 'scarf' ), array(
		'tag'        => 'h2',
	...
	<?php else : ?>
		<div class="scarf-empty-state">
			<p><?php esc_html_e( 'هنوز محصولی اضافه نشده است', 'scarf' ); ?></p>
